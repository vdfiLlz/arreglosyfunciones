...

{
    ...
    for (int i = 0; i < cantidadtotalcpp; i++)
    {
        ...
        cout << "La ram del dispositivo " << dispositivos[i].nombre << " es de :  " << endl;
        cout << (dispositivoActual.ram) << endl;
        cout << "Los nucleos del dispositivo " << // dispositivos[i].nucleos <<//
            " es de :  " << endl;
        cout << (dispositivoActual.nucleos) << endl;
        cout << "El almacenamineto en teras del dispositivo " << // dispositivos[i].almacentamientoteras <<//
            " es de :  " << endl;
